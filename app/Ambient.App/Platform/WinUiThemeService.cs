...
// ElementTheme.Default is follow-the-OS, so "system" tracks it live. The caption buttons are
// drawn by the shell from the app window's colours, not from XAML, so they are repainted
