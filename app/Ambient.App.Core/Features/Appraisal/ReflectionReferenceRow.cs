...
public sealed partial class ReflectionReferenceRow : ObservableObject
{
    ...
    /// <summary>The guideline or document title, after the reference unless it is the reference.</summary>
    ...
    // ", page 19" or ", pages 3, 5 and 9": where in the document the passages were
