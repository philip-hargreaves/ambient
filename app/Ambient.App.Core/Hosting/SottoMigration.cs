...
/// sotto folder to the ambient one. Per item and never overwriting, so a stray ambient
/// folder (an engine run before the first app launch) cannot block the real data from
/// carrying over, and a failure part way leaves every file where it can be found.
/// </summary>
