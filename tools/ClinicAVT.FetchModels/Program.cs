...
if (args.Length >= 3 && args[0] == "fetch")
{
    ...
    var needed = total + Packer.ShardBytes;  // plus one shard of transient space
...
// Tries IPv4 first because broken IPv6 routes otherwise stall every request until timeout
